...
const zh: Texts = {
  ...
  map_convenience_onestop_locs: "非教学类事务咨询 · CB - 117E · 0512-88161854",
  ...
  map_convenience_lockers_locs:
    "FB门口 / CB东侧花坛台阶处 / CB南门入口处 / 数学楼西门绿化带处 / 工科楼EB栋门口 / 南校区IR楼国际会议中心门口 / 南校区人文社科HS栋门口 / DB栋设计楼门口 / BS栋商学院东1号门",
...
const en: Texts = {
  ...
  profile_photo_hint: "Photos run building-sign OCR: match → intro popup + stamp; no match → random stamp",
  ...
  camera_subtitle: "Snap · Building scan · Unlock stamps",
  camera_count: "Photos: {n}",
  camera_shoot: "Take Photo",
  camera_album: "Choose from Album",
  camera_hint: "We scan for building codes (IR, SA, …). If matched, you get a building card + a stamp; otherwise a random stamp 🎖️",
  camera_empty_title: "Photograph Campus Buildings",
  camera_empty_sub: "Each photo runs building sign OCR.\nIf a building is recognised, you see its intro and unlock a stamp; if not, you still unlock a random stamp.",
