...
const zh: Texts = {
  ...
  nav_guide_home_desc: "这里可以快速回到首页，查看推荐内容和常用功能。",
  nav_guide_map_desc: "这里进入图片与地图，找教室、看导航都在这里。",
...
const en: Texts = {
  ...
  nav_guide_home_desc: "Go back to Home anytime for recommendations and quick actions.",
  nav_guide_map_desc: "Open Photos & Map to search classrooms and view navigation.",
