...
const zh: Texts = {
  ...
  home_lang_onboard_title: "语言切换 / Language Switch",
  home_lang_onboard_body_zh: "右上角「中文 / EN」可随时切换页面语言。",
  home_lang_onboard_body_en: "Use the top-right \"中文 / EN\" toggle to switch language anytime.",
  home_lang_onboard_btn: "我知道了 / Got it",
