...
const en: Texts = {
  ...
  camera_hint: "Same bilingual scan as Chinese mode (Eng + 中文 on signs). Match → intro in English + stamp; else random 🎖️",
  camera_empty_title: "Photograph Campus Buildings",
  camera_empty_sub: "Same bilingual OCR as Chinese mode.\nIf a building is recognised, you see its intro in English and unlock a stamp; if not, you still unlock a random stamp.",
